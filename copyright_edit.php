    ...
    <div class="row">
      ...
      <div class="col-lg-12 form-group">
        <label for="">Copyright Head</label>
          <input type="text" class="form-control" name="copy_right" value="<?php echo $copy_right; ?>">
      </div>
          
      <div class="col-lg-12 form-group">
        <label for="">URL Head</label>
          <input type="text" class="form-control" name="url_front" value="<?php echo $url_front; ?>">
      </div>
